...
dat.utils.common = function() {
    ...
    return {
        ...
        compose: function() {
            ...
            return function() {
                for(var e = a.call(arguments), c = d.length - 1; 0 <= c; c--)e = [
                    d[c].apply(this, e)
                ];
                return e[0];
            };
        ...
        each: function(a, e, c) {
            if (a) {
                ...
                else if (a.length === a.length + 0) for(var b = 0, p = a.length; b < p && !((b in a) && e.call(c, a[b], b) === this.BREAK); b++);
...
dat.dom.dom = function(f) {
    ...
    var e = /(\d+(\.\d+)?)px/, c = {
        ...
        getOffset: function(a) {
            ...
            if (a.offsetParent) do c.left += a.offsetLeft, c.top += a.offsetTop;
...
dat.GUI = dat.gui.GUI = function(f, a, d, e, c, b, p, q, l, r, n, u, A, g, k) {
    function v(a, b, h, d) {
        ...
        d.color ? b = new n(b, h) : (b = [
            b,
            h
        ].concat(d.factoryArgs), b = e.apply(a, b));
    ...
    function p(b, c, d) {
        if ("HEX" === b.__state.space) b.__state[c] = a.component_from_hex(b.__state.hex, d);
    ...
    Object.defineProperty(l.prototype, "hex", {
        get: function() {
            this.__state.space, this.__state.hex = a.rgb_to_hex(this.r, this.g, this.b);
...
//# sourceMappingURL=index.fe8b4577.js.map
